...
- No inline styles
- Verify builds after template changes

## Scope

Only modify frontend files. Do not touch backend logic,
infrastructure, CI, or deployment scripts. If a change
requires backend work, describe what's needed and stop.
